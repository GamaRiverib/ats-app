...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OAUTH_CLIENT_ID", function() { return OAUTH_CLIENT_ID; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OAUTH_URL", function() { return OAUTH_URL; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SERVER_TRUST_MODE", function() { return SERVER_TRUST_MODE; });
...
const CLIENT_ID = 'devmobile';
const CLIENT_SECRET = '0DOH6NGJ1HB1ERPF';
const OAUTH_CLIENT_ID = 'iot.core.y31i9vf';
const OAUTH_CLIENT_SECRET = 'hnkhqavnn4t06ctvplri1opva0q95qag';
const REDIRECT_URI = 'https://ats.gamarivera.dev/oauth2/r';
const OAUTH_URL = 'https://gamarivera.dev:84/auth';
const SERVER_URL = 'https://gamarivera.dev:84/api/ats';
const BROKER = {
    host: '192.168.0.173',
    port: 8883,
    protocol: 'ws',
...
const SERVER_TRUST_MODE = 'pinned';
...
module.exports = __webpack_require__(/*! D:\Projects\ats\ats-app\src\main.ts */"./src/main.ts");
