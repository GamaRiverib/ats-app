...
import { IMqttMessage, IMqttServiceOptions, IOnConnectEvent, IOnErrorEvent, IPublishOptions, MqttService } from 'ngx-mqtt';
import { BROKER, CLIENT_ID } from 'src/environments/environment';
import { AtsErrors, Channel, SensorLocation, SystemState } from '../app.values';
